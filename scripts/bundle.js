(() => {
  ...
  var menuToggle = header.querySelector(".menu__toggle");
  var iconOpen = header.querySelector(".menu__icon-open");
  var iconClose = header.querySelector(".menu__icon-close");
  var toggleMenu = () => {
  ...
  // source/js/api.js
  var sendData = (onSuccess, onFail, body) => {
    fetch(
      "",
      {
        method: "POST",
  ...
  var setFormSubmit = (form, onSuccess, onFail) => {
  ...
  var openModalButton = document.querySelector(".banner__reserve-button");
  var closeModalButton = modal.querySelector(".modal__close-button");
  var reservationForm = modal.querySelector(".reservation__form");
  var submitButton = modal.querySelector('button[type="submit"]');
  var onCloseModalButtonClick = () => {
    modal.classList.add("modal--close");
    clearForm(reservationForm);
  };
  var onReserveButtonClick = () => {
    setFormSubmit(
      reservationForm,
      () => {
        modal.classList.add("modal--close");
  ...
  // source/js/request-form.js
  var requestForm = document.querySelector(".request__form");
  var submitButton2 = document.querySelector(".request__button");
  var onRequestButtonClick = () => {
    setFormSubmit(
      requestForm,
      () => {
